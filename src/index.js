...
layui.extend({
    setter: 'config',                        // 全局配置文件
    admin: 'js/admin',                       // 核心模块
    view: 'js/view',                         // 视图模块
    global: 'js/global',                     // 全局事件
}).define(['setter', 'admin', 'global'], function (exports) {
    ...
    var setter = layui.setter,
        ...
        renderPage = function () {
            ...
            view().render(path.join('/')).then(function (res) {
                ...
                local.currentRouter = local.currentRouter || {};
                admin.currentRouter.title = res.title;
                admin.currentRouter.href = router.href;
                
                layui.data(setter.tableName, {
                    key: 'currentRouter',
                    value: admin.currentRouter
                });
    ...
    // 初始主体结构
    layui.link(
        setter.base + 'css/admin.css?v=' + (admin.v + '-1'),
        function () {
            entryPage()
        },
        'layuiAdmin'
    ...
    layui.link(setter.base + 'css/custom-styles.css?v=' + (admin.v + '-1'));
