 ...
 * 全局事件模块
 */
layui.define(['setter', 'admin', 'util', 'layer', 'view', 'table'], function (exports) {
    ...
    (function ($) {
        ...
        /**
         * 检查arg是一个至少有一个元素的数组，还是一个至少有一个键的dict
         * @return boolean
         */
    ...
    (function ($) {
        ...
        $.fn.fakeLoader = function (options) {
            ...
            var spinner03 = '<div class="fl spinner3"><div class="dot1"></div><div class="dot2"></div></div><div class="loader-text">' + loadText + '</div>';
            var spinner04 = '<div class="fl spinner4"></div><div class="loader-text">' + loadText + '</div>';
            var spinner05 = '<div class="fl spinner5"><div class="cube1"></div><div class="cube2"></div></div><div class="loader-text">' + loadText + '</div>';
            var spinner06 = '<div class="fl spinner6"><div class="rect1"></div><div class="rect2"></div><div class="rect3"></div><div class="rect4"></div><div class="rect5"></div></div><div class="loader-text">' + loadText + '</div>';
            var spinner07 = '<div class="fl spinner7"><div class="circ1"></div><div class="circ2"></div><div class="circ3"></div><div class="circ4"></div></div><div class="loader-text">' + loadText + '</div>';
