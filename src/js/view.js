...
layui.define(['laytpl', 'layer'], function (exports) {
    var $ = layui.jquery,
        ...
        SHOW = 'layui-show', LAY_BODY = 'nj_app_body',
    ...
    // 请求模板文件渲染
    Class.prototype.render = function (views, params, type) {
        var that = this,
            router = layui.router();
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                layui.use('admin', function () {
                    ...
                    // 判断类型是否为 popup 弹窗，如果不是，则修改浏览标题
                    if (type != 'popup') {
                        title ? admin.title.change(title) : admin.title.change(layui.setter.name);
                    }
                });
